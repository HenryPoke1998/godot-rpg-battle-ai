...
func _on_GolpeCertero_pressed():
	...
	if randf() < 0.40:  # 40% de probabilidad de acertar el golpe crítico
		var crit_damage = int(State.damage * 7) #revisar y considerar el daño base
...
func _on_CuracionMenor_pressed():
	...
	#Y SI COMENTAMOS ESTO AL FINAL SE QUEDA COMO PEGADO LA PANTALL
